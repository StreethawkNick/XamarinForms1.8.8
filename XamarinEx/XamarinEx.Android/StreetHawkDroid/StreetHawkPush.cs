...
namespace XamHawkDemo.Droid
{
	public class StreetHawkPush : IStreetHawkPush
	{
        ...
        public StreetHawkPush(Application application, MainActivity mainActivity)
        {
            mApplication = application;
            main = mainActivity;
        }
        ...
        {
            Push.GetInstance(mApplication.ApplicationContext).RegisterSHObserver(main);
        }
